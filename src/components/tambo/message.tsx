...
const messageVariants = cva("flex", {
  variants: {
    variant: {
      default: "",
      solid: [
        "[&>div>div:first-child]:shadow-[0_0_0_1px_rgba(255,255,255,0.8)_inset,0_4px_20px_-4px_rgba(139,92,246,0.12)]",
        "[&>div>div:first-child]:bg-white/80",
        "[&>div>div:first-child]:dark:bg-slate-800/80",
        "[&>div>div:first-child]:backdrop-blur-xl",
        "[&>div>div:first-child]:border",
        "[&>div>div:first-child]:border-white/50",
        "[&>div>div:first-child]:dark:border-slate-600/40",
        "[&>div>div:first-child]:rounded-2xl",
        "[&>div>div:first-child]:hover:bg-white/90",
        "[&>div>div:first-child]:dark:hover:bg-slate-800/90",
